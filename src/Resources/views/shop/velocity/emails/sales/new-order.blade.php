    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('shop::app.mail.order.dear', ['customer_name' => $order->customer_first_name.' '.$order->customer_last_name]) }},
            </p>
                            ...
                            <tr>
                                ...
                                <td data-value="{{ __('shop::app.customer.account.order.view.product-name') }}" style="text-align: left;padding: 8px">
                                    ...
                                    @if ( core()->getConfigData('delivery_time_slot.settings.general.status') )
                                        ...
                                        @endphp
                                        @include('delivery-time-slot::shop.customers.account.orders.delivery-time-slot', ['item' => $item, 'timeSlotData' => $timeSlotData])
                                    @endif
                                </td>
