                ...
                <div class="col-lg-7 col-md-12">
                    ...
                    <div
                        ...
                        <shipping-section
                            ...
                            @onTimeSlotMethodSelected="timeSlotMethodSelected($event)">
                        </shipping-section>
        ...
        (() => {
            ...
            Vue.component('checkout', {
                ...
                methods: {
                    ...
                    saveAddress: async function () {
                        ...
                        this.$http.post(shipping_save_route, this.address)
                            .then(response => {
                        ...
                        if (this.isCheckPayment) {
                            ...
                            if ( this.delivery_status == 1 ) {
                                ...
                                params = {
                                    ...
                                    'selected_delivery_slot': this.delivery_time_slot_value
                                };
                            }
                            // Delivery Time Slot End

                            this.$http.post(paymant_save_route, params)
                            .then(response => {
                    ...
                    placeOrder: async function () {
                        if (this.isPlaceOrderEnabled) {
                            ...
                            this.$http.post(order_place_route, params)
                            .then(response => {
                                if (response.data.success) {
                    ...
                    timeSlotMethodSelected: function(timeSlotMethod) {
                        if ( this.delivery_status == 1 ) {
                            this.delivery_time_slot_value = timeSlotMethod;
                        }
                    },// Delivery Time Slot End
            ...
            Vue.component('shipping-section', {
                ...
                methods: {
                    ...
                    // Delivery Time Slot Start
                    methodSelectedTimeSlot: function(event) {
                        let list = [];
                        let data = [];

                        if ( this.delivery_status == 1 ) {
                            this.clickedSlotsValue.push(event.target.value);
                            $.each(this.clickedSlotsValue, function(key, value) {
                                var str = value;
                                var res = str.split(",");
